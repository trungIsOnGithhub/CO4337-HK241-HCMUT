...
const InputForm = ({label, labelClassName, disabled, register, errors, id, validate, type='text', placeholder, fullWidth, defaultValue, style, readOnly, require, onInput, onChange, value}) => {
