    ...
    <div className='w-full'>
        <div className='h-[103px] w-full bg-[#0a66c2] flex justify-center items-center'>
          <div className='w-main flex items-center justify-between'>
            ...
            <input className='w-full p-4 pr-0 rounded-l-full bg-[#0a66c2] outline-none text-white font-medium placeholder:font-medium placeholder:text-gray-200 placeholder:italic placeholder:opacity-50' type='text' placeholder='Email address'/>
        ...
        <div className='h-[407px] w-full bg-gray-800 flex justify-center items-center text-white text-[13px]'>
          <div className='w-main flex'>
            ...
            <div className='flex-1 flex flex-col gap-2'>
              <h3 className='mt-[20px] text-[15px] font-medium border-l-2 border-[#0a66c2] pl-[15px]'>#DIGITALWORLDSTORE</h3>
            </div>
          </div>
        </div>
    </div>
