  ...
  return (
    <div>
      ...
      <div className='w-main h-[40px] flex items-center gap-12 border-b-2'>
        <span onClick={()=>{setVariable('service')}} className={clsx('text-gray-800 font-semibold text-xl cursor-pointer capitalize', variable === 'service' && 'text-[#0a66c2]')}>Service</span>
        <span onClick={()=>{setVariable('book')}} className={clsx('text-gray-800 font-semibold text-xl cursor-pointer capitalize', variable === 'book' && 'text-[#0a66c2]')}>Book Now</span>
        <span onClick={()=>{setVariable('product')}} className={clsx('text-gray-800 font-semibold text-xl cursor-pointer capitalize', variable === 'product' && 'text-[#0a66c2]')}>Product</span>
        <span onClick={()=>{setVariable('blog')}} className={clsx('text-gray-800 font-semibold text-xl cursor-pointer capitalize', variable === 'blog' && 'text-[#0a66c2]')}>Blog</span>
        <span onClick={()=>{setVariable('find-us')}} className={clsx('text-gray-800 font-semibold text-xl cursor-pointer capitalize', variable === 'find-us' && 'text-[#0a66c2]')}>Find us</span>
        <span onClick={()=>{setVariable('faq')}} className={clsx('text-gray-800 font-semibold text-xl cursor-pointer capitalize', variable === 'faq' && 'text-[#0a66c2]')}>FAQ</span>
        <span onClick={()=>{setVariable('chat')}} className={clsx('text-gray-800 font-semibold text-xl cursor-pointer capitalize', variable === 'faq' && 'text-[#0a66c2]')}>Chat</span>
      </div>
