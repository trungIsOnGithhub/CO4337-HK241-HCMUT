    ...
    <div className='relative z-10 w-full'>
      ...
      <div onClick={()=>setEditStaff(null)} className='text-[#00143c] cursor-pointer mr-4 ml-1'><FaArrowLeft size={28}/></div>
        ...
        />
          ...
          <div className='mt-8'>
            <button type='submit' disabled={isLoading} className={'px-4 py-2 rounded-md text-white bg-[#005aee] font-semibold w-fit h-fit flex gap-1 items-center disabled:opacity-50 disabled:cursor-not-allowed'}>
              {isLoading ? (
