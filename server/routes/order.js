...
router.get('/admin/:bookingid', [verifyAccessToken, isAdmin], ctrls.getOneOrderByAdmin)
router.post('/admin/staff_calendar',[verifyAccessToken, isAdmin], ctrls.getOrdersForStaffCalendar)
router.get('/',[verifyAccessToken], ctrls.getUserOrder)
router.get('/admin/getOrder/:userId', [verifyAccessToken, isAdmin], ctrls.getOrdersByUserId)
